...
<form class="layui-form" action="" method="post" lay-filter="initForm">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="path" lay-verify="path" autocomplete="off" placeholder="请输入路径" class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" name="level" lay-verify="level" autocomplete="off" placeholder="请输入权重" class="layui-input">
        </div>
